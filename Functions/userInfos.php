<?php
    ...
    function USER_INFOS_DEVICE_TYPE(){
    ...
    function USER_INFOS_OS_NANE(){
        ...
        foreach($arrayOSName AS $regex => $value):
    ...
    function USER_INFOS_BROWSER_NAME(){
        ...
        foreach($arrayBrowserName AS $regex=>$value):
